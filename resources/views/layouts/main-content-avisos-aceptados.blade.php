<h1>Avisos aceptados por Región</h1>
	      ...
	      <td>
	      	<?php $anuncios_aceptados = DB::table('anuncio')
                ...
                if($anuncios_totales[0]->anuncio_total != 0) 
            		$res = ($anuncios_aceptados[0]->anuncio_publicado / ($anuncios_totales[0]->anuncio_total) *100);
                else
                	$res = 0;
            ?>

	        <div class="progress progress-xs">
	          <div class="progress-bar progress-bar-success" style="width: {{$res}}%"></div>
	        </div>
	      </td>

	      <td><span class="badge bg-green">{{$res}}%</span></td>
	    </tr>
